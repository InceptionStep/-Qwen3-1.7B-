...
# SwanLab API Key（在平台生成）
# os.environ["SWANLAB_API_KEY"] = "X5eTKANz2150eG3o0ZoxB"
...
print("正在保存初始模型...")
trainer.save_model("./output/Qwen3-1.7B/checkpoint-0")
tokenizer.save_pretrained("./output/Qwen3-1.7B/checkpoint-0")
print("初始模型保存完成!")
